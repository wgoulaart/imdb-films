...
function getTitlesMostPopular() {
  return instance
    .request({
      method: 'GET',
      url: 'https://imdb8.p.rapidapi.com/title/get-most-popular-movies',
      params: { homeCountry: 'US', purchaseCountry: 'US', currentCountry: 'PT' }
    })
...
function getMostPopularMovies(param?: string) {
  return instance
...
function getMovieDetail(param?: string) {
  return instance
    .request({
      method: 'GET',
